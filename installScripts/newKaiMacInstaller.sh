...
*)
	...
	echo "you sure you want to install newKai?"
	echo
	;;
esac
done
...
pacstrap /mnt firefox nano-syntax-highlighting nitrogen pavucontrol pipewire pipewire-pulse wireplumber xf86-video-intel
echo "done"
echo
